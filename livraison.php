      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="livraison.php"> <i class="icon-grid"></i>Livraison </a></li>
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Commandes </a></li>
            <li><a href="forms.html"> <i class="icon-padnote"></i>Clients </a></li>
              <li><a href="afficherlivreur.php"> <i class="icon-padnote"></i>livreur </a></li>
                      ...
                      <div class="table-responsive">   
                        <table class="table table-striped table-sm">
                          ...
                          <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item " href="livraison.php?maction=trier&par=prenom">Prenom du client</a>
                          </div>
