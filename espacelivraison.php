...
{$maction=$_GET['maction'];
    ...
    $par=$_GET['par'];
    echo $par;
    $livraisons=$livraisons->trier($par);
}
?>
<!DOCTYPE html>
<html>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <!-- Logout    -->
                <li class="nav-item"><a href="espacelivraison.php" class="nav-link logout"> <span class="d-none d-sm-inline">Logout</span><i class="fa fa-sign-out"></i></a></li>
              </ul>
            </div>
          </div>
        </nav>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="livraison.php"> <i class="icon-grid"></i>Produits </a></li>
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>Commandes </a></li>
            <li><a href="forms.html"> <i class="icon-padnote"></i>Clients </a></li>
            <li><a href="login.php"> <i class="icon-interface-windows"></i>Marketing </a>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-sm">
                          ...
                          <?php foreach ($livraisons as $li){ ?>
                            <tr>
                              <th scope="row"><?php echo $li['code_Livraison']  ?></th>
                              <td><?php echo $li['nom']  ?></td>
                              <td><?php echo $li['prenom']  ?></td>
                              <td><?php echo $li['adresse_ligne_1']  ?></td>
                              <td><?php echo $li['adresse_ligne_2']  ?></td>
                              <td><?php echo $li['ville']  ?></td>
                              <td><?php echo $li['mail']  ?></td>
                              <td><?php echo $li['num_tel']  ?></td>
                              <td><?php echo $li['date_livraison']  ?></td>

                              <td>
                                  <ul>
                                          <a href="modifier.php?id=<?php echo $li['code_Livraison']?>" class="btn btn-primary">modifier</a>
                                          <a href="supprimerlivraison.php?id=<?php echo $li['code_Livraison']?>" class="btn btn-danger">supprimer</a>
                                      ...
                                      <a class="btn btn-dark dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                          ...
                                          <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                                              <a class="dropdown-item " href="espacelivraison.php?maction=trier&par=date_livraison">Date fin</a>
                                              </div>
