...
$l = new livraisonC();
$res = $l->afficherlivraisonforonetous($_GET['id']);
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="modifierlivraison.php" method="post">
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-3 form-control-label">addresse</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="addresse" value="<?php echo $m['adresse_ligne_1'] ?>">
                                            </div>
                                            <label class="col-sm-3 form-control-label">addresse</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="addresse1" value="<?php echo $m['adresse_ligne_2'] ?>">
                                            </div>
                                            <label class="col-sm-3 form-control-label">ville</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="ville" value="<?php echo $m['ville'] ?>">
                                            </div>
